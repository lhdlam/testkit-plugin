...
read `profiles/<target>.md`, scaffold the project layout + runner config, write `CLAUDE.md` (and mirror
`.cursor/rules/` for Cursor), and record the target in `${TESTKIT_ROOT:-e2e-tests/docs}/.testkit-target`.
